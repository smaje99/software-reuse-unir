...
\newcommand{\Asignatura}{Reutilización de Software}
...
\title{\textbf{Actividad: Patrones de creación}\\Sistema para procesar informes}
...
Finalmente, el proyecto completo se encuentra disponible en el repositorio \url{https://github.com/smaje99/software-reuse-unir}. Asimismo, junto a este documento se adjunta un archivo comprimido en formato ZIP que incluye el ejercicio desarrollado en Python, C\#, y Java, para facilitar su revisión y ejecución.
